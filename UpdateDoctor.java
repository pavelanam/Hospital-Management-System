...
public class UpdateDoctor extends JFrame implements ActionListener
{
	...
	public UpdateDoctor(JFrame frame)
	{
		super("Update Doctor");
		...
		title = new JLabel("UPDATE DOCTOR");
		...
		update.setBounds(540,535,200,40);
	...
	private void updateInDB()
	{
		...
		try
		{
			query = "UPDATE doctor SET Name='"+TFname.getText()+"',Age='"+TFage.getText()+"',Contact='"+TFcontact.getText()+"',City='"+TFcity.getText()+"',Gender='"+TFgender.getText()+"',Qualification='"+TFqualification.getText()+"',Specialist='"+TFspecialist.getText()+"',Salary='"+TFsalary.getText()+"' where ID="+TFid.getText();
